...
#TODO: Test out different values for the MIN_CONTOUR_SIZE
MIN_CONTOUR_SIZE = 0
...
def update():
    ...
    for color_bound in LINE_COLOR_PRIORITY:
        ...
        #TODO: Use countours_exist and find_countours with the hsv_lower adn hsv_upper bounds
        hsv_lower, hsv_upper = color_bound
        
        #TODO: If there is a countour visible, adjust SPEED and ANGLE

...
htmlhelp_basename = 'MITLLRACECARdoc'
...
latex_documents = [
    (master_doc, 'MITLLRACECAR.tex', u'MITLL RACECAR Documentation',
     u'Harvey Mudd College, MIT', 'manual'),
]
...
man_pages = [
    (master_doc, 'mitllracecar', u'MITLL RACECAR Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MITLLRACECAR', u'MITLL RACECAR Documentation',
     author, 'MITLLRACECAR', 'One line description of project.',
     'Miscellaneous'),
]

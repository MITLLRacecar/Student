...
class CameraSim(Camera):
    def __init__(self, racecar) -> None:
        ...
        self.__color_image: NDArray[Shape["480, 640, 3"], np.uint8] = None
        self.__is_color_image_current: bool = False
        self.__depth_image: NDArray[Shape["480, 640"], np.float32] = None
    ...
    def __request_color_image(self, isAsync: bool) -> NDArray[Shape["480, 640"], np.uint8]:
    ...
    def __request_depth_image(self, isAsync: bool) -> NDArray[Shape["480, 640"], np.float32]:
        self.__racecar._RacecarSim__send_header(
